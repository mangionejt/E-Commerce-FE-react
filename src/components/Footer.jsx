...
const Footer = () => {
  return (
    <Container>
        <Left>
            <Logo>ALEPH .</Logo>
            <Desc> I saw the earth and in the earth the Aleph
...
the unimaginable universe.</Desc>
<SocialContainer>
    ...
    <SocialIcon color="E60023">
        ...
        <Center>
            ...
            <List>
                ...
                <ListItem>The ineffable core of my story</ListItem>
                <ListItem>Terms</ListItem>
            </List>
        </Center>
        <Right>
            <Title>Contact</Title>
            <ContactItem><Room style={{marginRight:"10px"}} />Serrano 2135, Palermo, Buenos Aires.</ContactItem>
            <ContactItem><Phone style={{marginRight:"10px"}} /> +1 234 56 78</ContactItem>
            <ContactItem><MailOutline style={{marginRight:"10px"}} />mangionejt@gmail.com</ContactItem>
